...
export '/phone_login/phone_login_widget.dart' show PhoneLoginWidget;
...
export '/add_stocks/add_stocks_widget.dart' show AddStocksWidget;
export '/stocks_added/stocks_added_widget.dart' show StocksAddedWidget;
export '/pop_u_p/pop_u_p_widget.dart' show PopUPWidget;
